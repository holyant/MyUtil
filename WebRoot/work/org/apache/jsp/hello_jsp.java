...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t$(function(){\r\n");
      out.write("\t\t\t//location.href = \"json\";\r\n");
      out.write("\t\t\t//$.getJSON(\"json?data=\"+new Date(),function(json){\r\n");
      out.write("\t\t\t//\talert(\"holyant:\"+json.test);\r\n");
      out.write("\t\t\t//})\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//window.onload = function(){\r\n");
      out.write("\t\t//\talert(document.getElementById(\"test\"));\r\n");
      out.write("\t\t//};\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t</script>\r\n");
      ...
      out.write("  \r\n");
      out.write("  <body> \r\n");
      out.write("    </br>application.getRealPath(\"gridTest.jsp\"):");
      out.print(application.getRealPath("hello.jsp") );
      out.write("\r\n");
      out.write("    </br>new java.io.File(application.getRealPath(request.getRequestURI())).getParent():");
      out.print(new java.io.File(application.getRealPath(request.getRequestURI())).getParent());
      out.write("\r\n");
      out.write("    </br>request.getSession().getServletContext().getRealPath(\"hello.jsp\"):");
      out.print(request.getSession().getServletContext().getRealPath(""));
      out.write("\r\n");
      out.write("    </br>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${db.properties }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\r\n");
      out.write("    </br><input type=\"text\" value=\"lihao\" id=\"test\"><br>\r\n");
      out.write("    \r\n");
      out.write("    ");

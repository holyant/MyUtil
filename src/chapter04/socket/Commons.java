...
public class Commons {
	...
	"\t\t1£º\"sendMsg \n" +
	"\t\t2£º\"sendFile /home/xieyuooo/a.sql charset=utf-8\"\n" +
	"\t\t3£º\"sendBFile /home/xieyuooo/aaa.jpg\"\n" +
	"\t\t4£º\"getFile aaa.jpg d:/download/\" d:/download/user.dir\n" +
	"\t\t5help \n" +
	"\t\t6exit ";
	...
	public static String getCharsetNameByCode(byte charsetCode) {
		...
		throw new RuntimeException(" " + charsetCode);
	}
